...
namespace Ngsa.Middleware
{
    ...
    public class RequestLogger
    {
            ...
            if (App.Config.Prometheus)
            {
                requestDuration = Metrics.CreateHistogram(
                            ...
                            new HistogramConfiguration
                            {
                                ...
                                LabelNames = new string[] { "code", "category", "subcategory", "mode", "zone", "region", "cosmosname" },
                            });
            }
        }
        ...
        private static void LogRequest(HttpContext context, CorrelationVector cv, double ttfb, double duration)
        {
            ...
            {
                requestDuration.WithLabels(context.Response.StatusCode.ToString(), category, subCategory, mode, App.Config.Zone, App.Config.Region, CosmosName).Observe(duration);
            }
        }
